...
/**
 * Class UserJsonCreateRequest
 *
 * @package Railroad\Usora\Requests
 *
 * @bodyParam data.type string required  Must be 'user'. Example: user
 * @bodyParam data.attributes.email required string Example:test@test.te
 * @bodyParam data.attributes.display_name required string  Example:John Snow
 * @bodyParam data.attributes.password required string  Example:John
    ...
    public function onlyAllowed()
    {
        return $this->only(
            [
                ...
                'data.attributes.drums_skill_level',
                ...
                'data.attributes.guitar_skill_level',
                ...
                'data.attributes.piano_skill_level',
